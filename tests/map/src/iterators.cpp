...
void map_iterators(void) {
	...
	// 	copy_og_it = og_m.begin() + 2;
	// 	copy_my_it = my_m.begin() + 2;
	// 	og_it = og_m.begin();
	// 	my_it = my_m.begin();
	// 	assert(copy_my_it - my_it == copy_og_it - og_it);

	// 	copy_og_const_it = og_m_const.begin() + 2;
	// 	copy_my_const_it = my_m_const.begin() + 2;
	// 	og_const_it = og_m_const.begin();
	// 	my_const_it = my_m_const.begin();
	// 	assert(copy_my_const_it - my_const_it == copy_og_const_it - og_const_it);

	// 	copy_og_r_it = og_m.rbegin() + 2;
	// 	copy_my_r_it = my_m.rbegin() + 2;
	// 	og_r_it = og_m.rbegin();
	// 	my_r_it = my_m.rbegin();
	// 	assert(copy_my_r_it - my_r_it == copy_og_r_it - og_r_it);

	// 	copy_og_r_it_const = og_m_const.rbegin() + 2;
	// 	copy_my_r_it_const = my_m_const.rbegin() + 2;
	// 	og_r_it_const = og_m_const.rbegin();
	// 	my_r_it_const = my_m_const.rbegin();
	// 	assert(copy_my_r_it_const - my_r_it_const == copy_og_r_it_const - og_r_it_const);
	// }
}
        // std::cout << "og f: " << og_it->first << std::endl;
        // std::cout << "my f: " << my_it->first << std::endl;
        // std::cout << "og s: " << og_it->second << std::endl;
        // std::cout << "my s: " << my_it->second << std::endl;